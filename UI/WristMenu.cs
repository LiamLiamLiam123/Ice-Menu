    ...
    */
    ...
    internal class WristMenu : MonoBehaviour
    {
        ...
        public static List<ButtonInfo> buttons = new List<ButtonInfo> // main
        {
            ...
            new ButtonInfo { buttonText = "Save Buttons", method =() => Mods.Save1(), enabled = false, nontoggleable = true, toolTip = "Saves all currently enabled buttons!"},
        ...
        public static List<ButtonInfo> settingsbuttons = new List<ButtonInfo> // settings
        {
            ...
            new ButtonInfo { buttonText = "Theme ChangerV1", method =() => Mods.ThemeChangerV1(), enabled = false, nontoggleable = true, toolTip = "Change the first color the menu fades to!"},
            new ButtonInfo { buttonText = "Theme ChangerV2", method =() => Mods.ThemeChangerV2(), enabled = false, nontoggleable = true, toolTip = "Change the second color the menu fades to!"},
            new ButtonInfo { buttonText = "Theme ChangerV3", method =() => Mods.ThemeChangerV3(), enabled = false, nontoggleable = true, toolTip = "Change the color of buttons when they are disabled!"},
            new ButtonInfo { buttonText = "Theme ChangerV4", method =() => Mods.ThemeChangerV4(), enabled = false, nontoggleable = true, toolTip = "Change the color of buttons when they are enabled!"},
            new ButtonInfo { buttonText = "Theme ChangerV5", method =() => Mods.ThemeChangerV5(), enabled = false, nontoggleable = true, toolTip = "Change the color of the text on buttons when they are enabled!"},
            new ButtonInfo { buttonText = "Theme ChangerV6", method =() => Mods.ThemeChangerV6(), enabled = false, nontoggleable = true, toolTip = "Change the color of the text on buttons when they are disabled!"},
            new ButtonInfo { buttonText = "Theme ChangerV7", method =() => Mods.ThemeChangerV7(), enabled = false, nontoggleable = true, toolTip = "Change the sound of buttons!"},
        };
        #endregion
        #region Category 1
        ...
        public static List<ButtonInfo> CatButtons1 = new List<ButtonInfo>
        {
            ...
            new ButtonInfo { buttonText = "Fly", method =() => Mods.FlyMeth(15f), enabled = false, toolTip = "Fly like a bird!"},
            new ButtonInfo { buttonText = "Tracers", method =() => Mods.Tracers(), enabled = false, toolTip = "Lines towards everyone!"},
            new ButtonInfo { buttonText = "Bug Gun", method =() => Mods.ExampleOnHowToUseGunLib(), enabled = false, toolTip = "Just for an example of the GunLib!"},
        ...
        {
            "this is the motd title", // motd title
            "this is the coc title", // coc title
            "this is the coc description", // coc description
            "this is the motd description" // motd description
        };
        ...
        void Update()
        {
            try
            {
                ...
                if (ybuttonDown && !Mods.right)
                {
                    ...
                    {
                        menu.transform.position = GorillaLocomotion.GTPlayer.Instance.LeftHand.controllerTransform.position; // moves the menu to your left hand
                        ...
                        reference.transform.parent = GorillaLocomotion.GTPlayer.Instance.RightHand.controllerTransform; // attaches the pointer to your right hand
                ...
                else if (!ybuttonDown && !Mods.right && !menu.GetComponent<Rigidbody>())
                {
                    ...
                    menu.GetComponent<Rigidbody>().linearVelocity = GorillaLocomotion.GTPlayer.Instance.LeftHand.velocityTracker.GetAverageVelocity(true, 0f, false);
                }
                ...
                else if (!abuttonDown && Mods.right && !menu.GetComponent<Rigidbody>())
                {
                    ...
                    menu.GetComponent<Rigidbody>().isKinematic = false;
                    menu.GetComponent<Rigidbody>().useGravity = true;
                    menu.GetComponent<Rigidbody>().linearVelocity = GorillaLocomotion.GTPlayer.Instance.RightHand.velocityTracker.GetAverageVelocity(true, 0f, false);
                }
                // random shit
